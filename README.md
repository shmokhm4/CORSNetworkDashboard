# Continuous Operating Reference Stations (CORS) Network Dashboard — Saudi Arabia
...
It helps users explore the **geographical distribution**, **station types**, and **regional coverage** of CORS stations in Saudi Arabia.
...
- **Dynamic Filters:** Allows filtering by region and station type.  
